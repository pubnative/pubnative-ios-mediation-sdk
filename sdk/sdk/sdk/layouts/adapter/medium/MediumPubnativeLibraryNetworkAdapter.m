//
//  MediumPubnativeLibraryNetworkAdapter.m
//  sdk
//
...
#import "PNMediumLibraryAdapterViewController.h"
#import "PNSettings.h"
...
@interface MediumPubnativeLibraryNetworkAdapter () <PNAPILayoutFetchDelegate, PNAPILayoutLoadDelegate,PNAPILayoutViewControllerDelegate>

@property (nonatomic, strong) PNAPILayout *layout;
@property (nonatomic, strong) PNAPILayoutViewController *layoutViewController;
@property (nonatomic, strong) PNMediumLayoutContainerViewController *cachedView;

@end

@implementation MediumPubnativeLibraryNetworkAdapter
...
- (UIViewController*)viewController
{
    if (self.cachedView == nil) {
        self.cachedView = [[PNMediumLibraryAdapterViewController alloc] initWithViewController:self.layoutViewController];
    }
...
- (void)request:(NSDictionary *)networkData
{
    if (networkData == nil || networkData.count == 0) {
        ...
        [self.layout loadWithSize:MEDIUM loadDelegate:self];
    }
}
