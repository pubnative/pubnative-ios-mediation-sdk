...
NSString *NSStringFromPNProgressLabelColorTableKey(PNProgressLabelColorTable tableColor) {
    switch(tableColor) {
        case PNColorTable_ProgressLabelFillColor: return @"fillColor";
        case PNColorTable_ProgressLabelTrackColor: return @"trackColor";
        case PNColorTable_ProgressLabelProgressColor: return @"progressColor";
        default: return nil;
    }
}
...
UIColor *UIColorDefaultForColorInPNProgressLabelColorTableKey(PNProgressLabelColorTable tableColor) {
    switch(tableColor) {
        case PNColorTable_ProgressLabelFillColor: return [UIColor clearColor];
        case PNColorTable_ProgressLabelTrackColor: return [UIColor lightGrayColor];
        case PNColorTable_ProgressLabelProgressColor: return [UIColor blackColor];
        default: return nil;
    }
}
